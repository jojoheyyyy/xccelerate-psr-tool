# Xccelerate Portfolio Strategy Review
...
- Fill in client details, current portfolio, and proposed portfolio.
- The Summary section (and the exported PDF) highlight the before/after
  impact on protection, premiums, and projected retirement value.
- Click **Export client PDF** to download a 3-page, branded A4 landscape PDF.
